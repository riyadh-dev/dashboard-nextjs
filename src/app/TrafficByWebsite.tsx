...
export default function TrafficByWebsite() {
	return (
		<div className='w-full space-y-3 rounded-xl bg-white p-5 shadow-md dark:bg-neutral-800'>
			<h1 className='text-xl font-semibold'>Traffic By Website</h1>
			...
			<BarList
				...
				className={classNames(
					'[&>div>div>p]:!text-dark [&>div>div>p]:dark:!text-white',
					'mt-2'
				)}
			/>
		</div>
